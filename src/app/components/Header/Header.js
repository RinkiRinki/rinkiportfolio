                ...
                <nav className="invisible xl:visible xl:max-w-4xl mx-auto">
                    <ul className="flex font-recoletaBlack flex-row items-center h-24">
                        <li className="group text-2xl relative font-bold mr-20">
                            ...
                            href="/#home" onClick={()=> setSelectedIndex1(0)}
                            >Home</a>
                        </li>
                        ...
                        <li className="group text-2xl relative font-bold mr-20">
                            ...
                            <a className={`menu-item ${selectedIndex1 === 0 ? "text-black":""} text-[#666d47] group-hover:text-black`}
                            href="/#portfolio" onClick={()=> setSelectedIndex1(1)}
                            >Portfolio</a>
                        </li>
                        ...
                        <li className="group text-2xl relative font-bold mr-20">
                            ...
                            <a className={`menu-item ${selectedIndex1 === 0 ? "text-black":""} text-[#666d47] group-hover:text-black`}
                            href="/#about-me-component" onClick={()=> setSelectedIndex1(2)}
                            >AboutMe</a>
                        </li>
                        ...
                        <li className="group text-2xl relative font-bold mr-20">
                            ...
                            <a className={`menu-item ${selectedIndex1 === 0 ? "text-black":""} text-[#666d47] group-hover:text-black`}
                            href="/page/contactme" onClick={()=> setSelectedIndex1(3)}
                            >Hire Me</a>
                        </li>
                    </ul>
                </nav>
