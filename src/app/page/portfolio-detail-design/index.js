...
export default function Index({id, data, DataArray}){
    ...
    return(
        ...
        <div className="absolute z-30 top-[42px] sm:top-[200px] sm:left-[65px] justify-center items-center w-full  px-10 sm:w-3/4 xl:w-1/2 sm:px-0  sm:text-left">
            <div className="container m-auto">
              ...
              Project Sample
                    ...
                    <p className="opacity-3 text-[#223740] sm:text-left text-center w-full sm:w-3/4 font-recoletaBold text-4xl md:text-4xl lg:text-4xl xl:text-4xl">{data?.title}</p>
                </div>
            </div>
        </div>    
        ...
        >
            ...
            <div className="col-span-12 lg:col-span-4 lg:px-0 sm:px-20">
                <div className="mt-10 sm:mt-24 w-full lg:max-w-[300px] lg:px-1 px-3 sticky top-36 pb-14">
                    ...
                    <p className="text-[14px] font-sans mb-4 text-[#223740]">{data?.des}</p>
                    <p id="highlight" className="my-2 text-dark text-[20px] font-sans">Project Descriptions</p>
                    <p className="text-[14px] font-sans mb-4 text-[#223740]">{data?.des1}</p>
        ...
        <div className="relative flex bg-accent-color h-48 text-white">
            <div className={`group w-1/2 items-center justify-center bg-cover ${hind.className}`}
