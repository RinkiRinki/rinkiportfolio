    ...
    return(
        <React.Fragment>
            ...
            <div className='flex flex-col items-center justify-center w-full pt-[80px] pb-[80px] mt-4'>
                <div className='flex flex-col items-center justify-center bg-[url("/offices.jpg")] bg-cover w-full h-[400px] bg-center' >
                    <div className="flex flex-col items-center justify-center w-full h-full bg-[#223740]/70 backdrop:brightness-50">
                        ...
                        <div className="flex justify-center text-center mt-[10px] md:w-[700px]">
                            <p className="text-white font-[300] text-center text-xl">Are you looking for a responsible, professional full-stack developer and designer for your website or your web application projects? Just leave me a message and tell me how I can help.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="px-[20px]">
                    <div className="sm:flex gap-[20px] mt-[50px] max-w-[1105px] w-full h-full">
                        <div className="flex flex-col flex-1 xl:flex-row gap-[20px]">
                            ...
                            <div className="flex flex-col py-[35px] px-[45px] rounded-lg shadow-lg cursor-pointer transition-all transform duration-300 hover:bg-[#223740] hover:text-white hover:-translate-y-4 bg-white"
                        ...
                        <div>
                            <p className="text-[#666666]">Sonipat, Haryana</p>
                        </div>
                        </div>
                        ...
                        <div>
                            <p className="text-[#666666]">+91 9467774964</p>
                        </div>
                        </div>
                        ...
                        <div>
                            <p className="text-[#666666]">rinki22032000@gmail.com</p>
                        </div>
                        </div>
                        </div>
        ...
        <div id="contact" className="flex flex-col xl:flex-row justify-center gap-[60px] mt-[10px] px-[30px] max-w-[1105px] m-auto p-10">
            ...
            >
                ...
                <div className="absolute inset-0 flex flex-col gap-[20px] items-center justify-center text-white shadow-lg p-6">
                    ...
                    <div>
                        <button className="bg-[#48AFDE] text-white mb-[30px] px-4 py-2 hover:bg-[#223740] transition-colors rounded-xl">Let's Chat</button>
                    </div>
                </div>
            </div> */}
            <div className="flex flex-col gap-[20px]">
                <div className="text-center w-[100px] py-[1px] bg-red-300 tracking-wide uppercase font-300 font-sans text-[14px] text-white rounded-lg">
                    Contact Us
                </div>
                <div className="">
                    <p className="text-[30px] text-[#48AFDE]">Request A Call Back ! Feel Free To Reach & Contact Me.</p>
                </div>
                <form className="flex flex-col gap-[20px]" onSubmit={handleSubmit}>
                    <div className={`flex flex-col sm:flex-row gap-[20px] ${hind.className}`}>
                        <input type="text" name="name" placeholder="Your Name" required onChange={handleChange} value={state.name} className="px-[12px] outline-none rounded-md py-[12px] flex-1 bg-gray-200"/>
                        <input type="email" name="email" placeholder="Your Email" required onChange={handleChange} value={state.email} className="px-[12px] outline-none rounded-md py-[12px] flex-1 bg-gray-200"/>
                    </div>

                    <div className={`flex flex-col sm:flex-row gap-[20px] ${hind.className}`}>
                        <input type="text" name="phoneNumber" placeholder="Your Number" required onChange={handlePhoneChange} value={state.phoneNumber} className="px-[12px] outline-none rounded-md py-[12px] flex-1 bg-gray-200"/>
                        <input type="text" name="subject" placeholder="Your Subject" required onChange={handleChange} value={state.subject} className="px-[12px] outline-none rounded-md py-[12px] flex-1 bg-gray-200"/>
                    </div>

                    <div className={`${hind.className}`}>
                        <textarea
                        required
                        onChange={handleChange} value={state.message}
                        name="message"
                        placeholder="Your Message"
                        className="px-[12px] outline-none rounded-md py-[12px] flex-1 bg-gray-200 h-[180px] w-full"/>
                    </div>
                    ...
                    <div className="">
                        ...
                        <button className="bg-[#48AFDE] w-full sm:w-auto px-[30px] py-[12px] hover:bg-[#223740] transition-colors duration-300 font-semibold text-white rounded-lg" >Send Message</button>
                    </div>
                </form>
            </div>
        </div>
